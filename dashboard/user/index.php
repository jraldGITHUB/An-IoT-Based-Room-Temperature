...
<li class="nav-item"><a class="nav-link active" href="../user/index.php">Dashboard</a></li>
<li class="nav-item"><a class="nav-link" href="../user/logs_page/index.php">Logs</a></li>
...
<div class="info-panel">
    ...
    <div class="stat-row">
        <div class="stat-box"><div class="stat-label">Average</div><div class="stat-val" id="avgTemp">-- °C</div></div>
        <div class="stat-box"><div class="stat-label">Minimum</div><div class="stat-val" id="minTemp">-- °C</div></div>
        <div class="stat-box" style="grid-column:1/-1"><div class="stat-label">Maximum</div><div class="stat-val" id="maxTemp">-- °C</div></div>
    </div>
</div>
</div>
