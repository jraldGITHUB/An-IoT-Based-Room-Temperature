...
<!-- ✅ FIXED: all paths now say manager not admin -->
<li class="nav-item"><a class="nav-link active" href="../manager/index.php">Dashboard</a></li>
<li class="nav-item"><a class="nav-link" href="../manager/logs_page/index.php">Logs</a></li>
<li class="nav-item"><a class="nav-link" href="../manager/add_monitor_rooms/index.php">Manage Rooms</a></li>
<li class="nav-item"><a class="nav-link" href="../manager/activity_logs/index.php">Activity Logs</a></li>
