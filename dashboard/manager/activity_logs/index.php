...
<div class="kpi-card">
    ...
    <div class="kpi-value kpi-blue"><?php echo $totalRooms; ?></div>
</div>
<div class="kpi-card">
    <div class="kpi-label">Active Sensors</div>
    <div class="kpi-value kpi-green"><?php echo $activeSensors; ?></div>
</div>
<div class="kpi-card">
    <div class="kpi-label">Avg Temperature</div>
    <div class="kpi-value kpi-orange"><?php echo number_format($avgTemp,2); ?>°C</div>
</div>
</div>
